    ...
    <footer class="px-4  sm:p-6 bg-gray-800">
        <div class="pt-10 mx-auto max-w-screen-xl">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm sm:text-center text-gray-400">© 2022 <a href="https://www.linkedin.com/in/mohamed-galdi/" target='_blank'
                ...
                <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    ...
                    <a href="https://www.linkedin.com/in/mohamed-galdi/" target='_blank' class="text-gray-500  hover:text-white">
                    ...
                    <a href="https://www.instagram.com/galldii/" target='_blank' class="text-gray-500  hover:text-white">
                        <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill-rule="evenodd"
